...
MindLift is a wellness web application for journaling, mood tracking, music therapy, and AI companion chat. The web version focuses on mental wellness features and does not include yoga pose detection.
